...
async function getData(){
  let ax=axios.get('https://crudcrud.com/api/3900712053364deca04890fb0252dfe3/appoint')
   .then((res)=>{
    details=res.data;
...
function setData(n,e){
  axios.post('https://crudcrud.com/api/3900712053364deca04890fb0252dfe3/appoint',{
    'name':n.value,
    'email':e.value
  }).then(res=>{
    details=res.data;
...
function updateData(n,e,id){
  axios.patch('https://crudcrud.com/api/3900712053364deca04890fb0252dfe3/appoint/'+id,{
    name:n.value,
    email:e.value
  })
  .then((res)=>{
...
function update(index){
 ...
 async function deleteData(i){
  ...
  axios.delete('https://crudcrud.com/api/3900712053364deca04890fb0252dfe3/appoint/'+id)
  .then((res)=>{
    details=res.data;
    console.log(id);
  })
